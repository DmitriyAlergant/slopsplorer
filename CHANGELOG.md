...
- Diff controls, readouts, and file columns now use Added, Removed, Churn, Net order, each file shows relative Churn and Net against its exact before image, and total strips replace the Files readout with Net %.
